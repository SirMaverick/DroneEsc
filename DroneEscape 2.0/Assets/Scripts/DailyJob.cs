                ...
                for (int x = -maxAmountFixed + 1; x < maxAmountFixed; x++) {
                    ...
                    for (int y = -maxAmountFixed + 1; y < maxAmountFixed; y++) {
                        ...
                        for (int i = 1; i < arrayList.Count - 1; i++) {
                            ...
                            temp = arrayList[i];
                            temp[xFixed, yFixed] = new Vector3(transform.position.x + x * width, transform.position.y + yFixed * height + (-maxAmountFixed + i) * maxAmount * height + 2 * height, transform.position.z);
                            arrayList[i] = temp;
                        }
                    }
                }
